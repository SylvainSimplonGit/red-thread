...
(nextval('actor_seq_id'), 'Thierry Lhermitte'),
(nextval('actor_seq_id'), 'Michel Blanc'),
(nextval('actor_seq_id'), 'Josiane Balasko'),
(nextval('actor_seq_id'), 'Christian Clavier'),
(nextval('actor_seq_id'), 'Gérard Jugnot'),
(nextval('actor_seq_id'), 'Dominique Lavanant'),
(nextval('actor_seq_id'), 'Bruno Moynot'),
(nextval('actor_seq_id'), 'Maurice Chevit')
;
